...
- To understand and analyze an SMS spam dataset.
- To preprocess text data for machine learning.
- To convert text into numerical features using TF-IDF.
- To apply different machine learning algorithms.
...
7. Perform dimensionality reduction using SVD
